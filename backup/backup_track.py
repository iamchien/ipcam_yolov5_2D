...
import sys
sys.path.insert(0, 'E:\Documents\20211113_Projects\VTel\Yolov5_DeepSort_Pytorch\yolov5')
...
def run(opt, model, device):
    out, source, deep_sort_weights, show_vid, save_vid, save_txt, imgsz, half = \
        opt.output, opt.source, opt.deep_sort_weights, opt.show_vid, opt.save_vid, \
